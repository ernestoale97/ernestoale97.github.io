...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm} = {}) {
    ...
    const dart2wasm = {
      ...
      _1811: (handle) => clearInterval(handle),
      _1812: (c) =>
      ...
      _1819: x0 => x0.getAllResponseHeaders(),
      _1828: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1828(f,arguments.length,x0) }),
      _1829: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1830: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1851: (s, m) => {
        try {
      ...
      _2058: (x0,x1) => x0.withCredentials = x1,
      _2060: x0 => x0.responseURL,
      _2061: x0 => x0.status,
      _2062: x0 => x0.statusText,
